 ...
 *                                                                          ve tříde BankAccount, a subjects nastav na nový prázdný slovník
 * 
...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(rectangle.CalculateAspectRatio());
            Console.WriteLine(rectangle.ContainsPoint(4,2));
